...
export const siteConfig: SiteConfig = {
	...
	navbar: {
		...
		// 2. 本地图片（public目录，不优化）: { type: "icon", value: "/assets/images/logo.webp", alt: "Logo" }
		// 3. 本地图片（src目录，自动优化但会增加构建时间）: { type: "icon", value: "assets/images/logo.webp", alt: "Logo" }
		// 4. 网络图片: { type: "url", value: "https://example.com/logo.png", alt: "Logo" }
		// image 和 url 类型可额外设置 valueDark，用于暗色模式下显示另一张图片，不设置则亮暗色共用 value
		// 例如: { type: "icon", value: "assets/images/logo.png", valueDark: "assets/images/logo-dark.png", alt: "Logo" }
