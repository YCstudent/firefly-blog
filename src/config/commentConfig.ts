...
export const commentConfig: CommentConfig = {
	...
	//twikoo评论系统配置
	twikoo: {
		envId: "https://twikoo-cloudflare.2917321268.workers.dev",
		// 设置 Twikoo 评论系统语言
		lang: "zh-CN",
		// 是否启用文章访问量统计功能
		visitorCount: true,
		...
		// 国际推荐: https://registry.npmmirror.com/twikoo/1.7.14/files/dist/twikoo.min.js
		jsUrl:
	...
	giscus: {
		// 设置 Giscus 评论系统仓库
		repo: "YCstudent/firefly-blog",
		// 设置 Giscus 评论系统仓库ID
		repoId: "R_kgDOTwvyhA",
		// 设置 Giscus 评论系统分类
		category: "General",
		// 获取 Giscus 评论系统分类ID
		categoryId: "DIC_kwDOTwvyhM4DC4zA",
		// 获取 Giscus 评论系统映射方式
		mapping: "title",
		// 获取 Giscus 评论系统严格模式
		strict: "0",
